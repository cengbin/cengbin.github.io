import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.6ae5a3d9.js";const Q=JSON.parse('{"title":"jquery.js 源码学习","description":"","frontmatter":{},"headers":[],"relativePath":"5 源码学习/jquery.md","filePath":"5 源码学习/jquery.md"}'),l={name:"5 源码学习/jquery.md"},p=a(`<h1 id="jquery-js-源码学习" tabindex="-1">jquery.js 源码学习 <a class="header-anchor" href="#jquery-js-源码学习" aria-label="Permalink to &quot;jquery.js 源码学习&quot;">​</a></h1><p>如下极致精简版jquery.js代码</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">(function (){</span></span>
