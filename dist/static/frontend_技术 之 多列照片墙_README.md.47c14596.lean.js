import{_ as n,o as a,c as l,O as p}from"./chunks/framework.d9e2f5d0.js";const h=JSON.parse('{"title":"多列照片墙实现","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/技术 之 多列照片墙/README.md","filePath":"frontend/技术 之 多列照片墙/README.md"}'),e={name:"frontend/技术 之 多列照片墙/README.md"};function o(t,s,c,r,i,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="多列照片墙实现" tabindex="-1">多列照片墙实现 <a class="header-anchor" href="#多列照片墙实现" aria-label="Permalink to &quot;多列照片墙实现&quot;">​</a></h1><h2 id="属性" tabindex="-1">属性 <a class="header-anchor" href="#属性" aria-label="Permalink to &quot;属性&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
...
<span class="line"><span style="color:#24292e;">})</span></span></code></pre></div>`,11)]))}const m=n(e,[["render",o]]);export{h as __pageData,m as default};
