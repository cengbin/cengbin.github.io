import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.0f4e1e9e.js";const o="/static/NPM.3cf065c2.jpg",p="/static/图1.5d317ce9.jpg",m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/15 模块管理器NPM & Yarn &PNPM/README.md","filePath":"frontend/15 模块管理器NPM & Yarn &PNPM/README.md"}'),l={name:"frontend/15 模块管理器NPM & Yarn &PNPM/README.md"},t=a('<p><img src="'+o+`" alt=""></p><h2 id="npm" tabindex="-1">NPM <a class="header-anchor" href="#npm" aria-label="Permalink to &quot;NPM&quot;">​</a></h2><p>Node Package Manager，即“node包管理器”。npm 发展到今天，可以说经历过三个重大的版本变化。</p><h3 id="npm-v1-v2" tabindex="-1">npm v1-v2 <a class="header-anchor" href="#npm-v1-v2" aria-label="Permalink to &quot;npm v1-v2&quot;">​</a></h3><p>最早的 npm 版本在管理依赖时使用了一种很简单的方式。我们称之为嵌套模式。比如，在你的项目中有如下的依赖。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&quot;dependencies&quot;: {</span></span>
