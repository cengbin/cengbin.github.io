import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.0f4e1e9e.js";const l="/static/640.76b22e50.gif",p="/static/WX20240606-093541@2x.0db97dba.png",m=JSON.parse('{"title":"前端代码片段","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/63 代码片段/README.md","filePath":"frontend/63 代码片段/README.md"}'),o={name:"frontend/63 代码片段/README.md"},t=e(`<h1 id="前端代码片段" tabindex="-1">前端代码片段 <a class="header-anchor" href="#前端代码片段" aria-label="Permalink to &quot;前端代码片段&quot;">​</a></h1><h2 id="_1-快速打开官网" tabindex="-1">1. 快速打开官网 <a class="header-anchor" href="#_1-快速打开官网" aria-label="Permalink to &quot;1. 快速打开官网&quot;">​</a></h2><p>当你想查看第三方库的主页和代码仓库时，你可以使用一下命令快速打开：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 打开主页</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p><img src="`+p+`" alt="图片"></p><h2 id="_6-滚动条样式" tabindex="-1">6. 滚动条样式 <a class="header-anchor" href="#_6-滚动条样式" aria-label="Permalink to &quot;6. 滚动条样式&quot;">​</a></h2><p>自定义滚动条样式也是很常见的需求，除了通过样式，也可以通过第三方库（如 better-scroll 等）来实现自定义滚动条样式。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">/*定义滚动条高宽及背景 高宽分别对应横竖滚动条的尺寸*/</span></span>
...
<span class="line"><span style="color:#24292e;">[2024-04-01T12:00:00.000Z] [ERROR] Failed to load.</span></span></code></pre></div><p><a href="https://mp.weixin.qq.com/s/778hr32KnLFEw7oBNt38sg" target="_blank" rel="noreferrer">N 个值得一看的前端代码片段</a></p>`,48),c=[t];function i(r,d,y,u,h,g){return n(),a("div",null,c)}const v=s(o,[["render",i]]);export{m as __pageData,v as default};
