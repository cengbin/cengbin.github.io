import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.0f4e1e9e.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"backend/笔记/README.md","filePath":"backend/笔记/README.md"}'),o={name:"backend/笔记/README.md"},t=e(`<h2 id="分页接口返回数据设计" tabindex="-1">分页接口返回数据设计： <a class="header-anchor" href="#分页接口返回数据设计" aria-label="Permalink to &quot;分页接口返回数据设计：&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
