import{_ as i,C as a,o as y,c as E,k as e,a as s,H as n,Q as p}from"./chunks/framework.0f4e1e9e.js";const k=JSON.parse('{"title":"Element UI 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/98 笔记/Element UI 笔记.md","filePath":"frontend/98 笔记/Element UI 笔记.md"}'),u={name:"frontend/98 笔记/Element UI 笔记.md"},d=p(`<h1 id="element-ui-笔记" tabindex="-1">Element UI 笔记 <a class="header-anchor" href="#element-ui-笔记" aria-label="Permalink to &quot;Element UI 笔记&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">Vue.use(Element, {</span></span>
