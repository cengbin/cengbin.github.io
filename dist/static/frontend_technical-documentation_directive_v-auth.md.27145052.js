import{_ as s,o as n,c as a,O as e}from"./chunks/framework.d9e2f5d0.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/technical-documentation/directive/v-auth.md","filePath":"frontend/technical-documentation/directive/v-auth.md"}'),l={name:"frontend/technical-documentation/directive/v-auth.md"};function o(p,t,c,u,r,i){return n(),a("div",null,t[0]||(t[0]=[e(`<h3 id="v-auth-指令" tabindex="-1">v-auth 指令 <a class="header-anchor" href="#v-auth-指令" aria-label="Permalink to &quot;v-auth 指令&quot;">​</a></h3><h3 id="使用示例" tabindex="-1">使⽤示例 <a class="header-anchor" href="#使用示例" aria-label="Permalink to &quot;使⽤示例&quot;">​</a></h3><p>功能权限、筛选权限使⽤指令⽅式控制</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;template&gt;</span></span>
...
<span class="line"><span style="color:#24292e;">&lt;/template&gt;</span></span></code></pre></div>`,4)]))}const h=s(l,[["render",o]]);export{y as __pageData,h as default};
