import{_ as r,C as n,o as u,c as d,k as l,a as s,H as e,Q as t}from"./chunks/framework.0f4e1e9e.js";const C=JSON.parse('{"title":"Element UI 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/9 笔记/Element UI/README.md","filePath":"frontend/9 笔记/Element UI/README.md"}'),y={name:"frontend/9 笔记/Element UI/README.md"},g=t(`<h1 id="element-ui-笔记" tabindex="-1">Element UI 笔记 <a class="header-anchor" href="#element-ui-笔记" aria-label="Permalink to &quot;Element UI 笔记&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">Vue.use(Element, {</span></span>
