...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">/* stylelint-disable-next-line no-descending-specificity */</span></span></code></pre></div><p><strong>写 CSS 总结</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 颜色值这样写，stylelint 检测的时候才不会报错。</span></span>
