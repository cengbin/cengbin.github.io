import{_ as n,o as s,c as a,Q as e}from"./chunks/framework.0f4e1e9e.js";const h=JSON.parse('{"title":"关于Array.apply(null,类数组对象)","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/6 Array.apply(null,类数组对象) 详解/README.md","filePath":"frontend/6 Array.apply(null,类数组对象) 详解/README.md"}'),l={name:"frontend/6 Array.apply(null,类数组对象) 详解/README.md"},p=e(`<h1 id="关于array-apply-null-类数组对象" tabindex="-1">关于Array.apply(null,类数组对象) <a class="header-anchor" href="#关于array-apply-null-类数组对象" aria-label="Permalink to &quot;关于Array.apply(null,类数组对象)&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">let arr1 = new Array(2)</span></span>
