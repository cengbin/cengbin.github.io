...
<span class="line"><span style="color:#24292e;">        name: &#39;我是一个umd模块&#39;</span></span>
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}))</span></span></code></pre></div><p>参考链接：<a href="https://juejin.cn/post/6844903927104667662" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903927104667662</a></p><h3 id="_5-es6模块化" tabindex="-1">5. ES6模块化 <a class="header-anchor" href="#_5-es6模块化" aria-label="Permalink to &quot;5. ES6模块化&quot;">​</a></h3><h4 id="概述" tabindex="-1">概述 <a class="header-anchor" href="#概述" aria-label="Permalink to &quot;概述&quot;">​</a></h4><p>在 ES6 前， 实现模块化使用的是 RequireJS 或者 seaJS（分别是基于 AMD 规范的模块化库， 和基于 CMD 规范的模块化库）。</p><p>ES6 引入了模块化，其设计思想是在编译时就能确定模块的依赖关系，以及输入和输出的变量。</p><p>ES6 的模块化分为导出（export） @与导入（import）两个模块。</p><h4 id="特点" tabindex="-1">特点 <a class="header-anchor" href="#特点" aria-label="Permalink to &quot;特点&quot;">​</a></h4><p>ES6 的模块自动开启严格模式，不管你有没有在模块头部加上 use strict;。</p><p>模块中可以导入和导出各种类型的变量，如函数，对象，字符串，数字，布尔值，类等。</p><p>每个模块都有自己的上下文，每一个模块内声明的变量都是局部变量，不会污染全局作用域。</p><p>每一个模块只加载一次（是单例的）， 若再去加载同目录下同文件，直接从内存中读取。</p><h2 id="四、参考链接" tabindex="-1">四、参考链接 <a class="header-anchor" href="#四、参考链接" aria-label="Permalink to &quot;四、参考链接&quot;">​</a></h2><ul><li><a href="https://segmentfault.com/a/1190000017466120" target="_blank" rel="noreferrer">https://segmentfault.com/a/1190000017466120</a></li><li><a href="https://juejin.cn/post/6844903961128861704" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903961128861704</a></li><li><a href="https://www.runoob.com/w3cnote/es6-module.html" target="_blank" rel="noreferrer">https://www.runoob.com/w3cnote/es6-module.html</a></li></ul>`,61),o=[p];function t(c,i,r,d,u,h){return s(),e("div",null,o)}const f=a(l,[["render",t]]);export{y as __pageData,f as default};
