import{_ as y,A as l,o as E,c as u,O as p,k as o,a as n,E as a}from"./chunks/framework.d9e2f5d0.js";const C=JSON.parse('{"title":"Element UI 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/98 笔记/Element UI 笔记.md","filePath":"frontend/98 笔记/Element UI 笔记.md"}'),d={name:"frontend/98 笔记/Element UI 笔记.md"};function g(h,s,q,m,v,F){const t=l("form-item"),c=l("el-from"),e=l("el-select"),r=l("el-input"),i=l("el-form-item");return E(),u("div",null,[s[8]||(s[8]=p(`<h1 id="element-ui-笔记" tabindex="-1">Element UI 笔记 <a class="header-anchor" href="#element-ui-笔记" aria-label="Permalink to &quot;Element UI 笔记&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">Vue.use(Element, {</span></span>
