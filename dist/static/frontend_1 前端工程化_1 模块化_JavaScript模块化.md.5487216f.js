import{_ as a,o as s,c as e,Q as n}from"./chunks/framework.0f4e1e9e.js";const y=JSON.parse('{"title":"JavaScript模块及发展过程","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/1 前端工程化/1 模块化/JavaScript模块化.md","filePath":"frontend/1 前端工程化/1 模块化/JavaScript模块化.md"}'),l={name:"frontend/1 前端工程化/1 模块化/JavaScript模块化.md"},p=n(`<h1 id="javascript模块及发展过程" tabindex="-1">JavaScript模块及发展过程 <a class="header-anchor" href="#javascript模块及发展过程" aria-label="Permalink to &quot;JavaScript模块及发展过程&quot;">​</a></h1><h3 id="目录" tabindex="-1">目录 <a class="header-anchor" href="#目录" aria-label="Permalink to &quot;目录&quot;">​</a></h3><ul><li>前言</li><li>模块化的理解</li><li>模块化规范</li><li>参考链接</li></ul><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在JavaScript发展初期就是为了实现简单的页面交互逻辑，寥寥数语即可；如今CPU、浏览器性能得到了极大的提升，很多页面逻辑迁移到了客户端（表单验证等），随着web2.0时代的到来，Ajax技术得到广泛应用，jQuery等前端库层出不穷，前端代码日益膨胀，此时在JS方面就会考虑使用模块化规范去管理。</p><h2 id="模块化的理解" tabindex="-1">模块化的理解 <a class="header-anchor" href="#模块化的理解" aria-label="Permalink to &quot;模块化的理解&quot;">​</a></h2><h3 id="_1-什么是模块" tabindex="-1">1.什么是模块？ <a class="header-anchor" href="#_1-什么是模块" aria-label="Permalink to &quot;1.什么是模块？&quot;">​</a></h3><ul><li>将一个复杂的程序依据一定的规则(规范)封装成几个块(文件), 并进行组合在一起</li><li>块的内部数据与实现是私有的, 只是向外部暴露一些接口(方法)与外部其它模块通信</li></ul><h3 id="_2-模块化的进化过程" tabindex="-1">2.模块化的进化过程 <a class="header-anchor" href="#_2-模块化的进化过程" aria-label="Permalink to &quot;2.模块化的进化过程&quot;">​</a></h3><ul><li>全局function模式 : 将不同的功能封装成不同的全局函数</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">function m1(){</span></span>
