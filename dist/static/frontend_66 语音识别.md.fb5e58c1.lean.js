import{_ as n,o as e,c as a,O as p}from"./chunks/framework.d9e2f5d0.js";const d=JSON.parse('{"title":"语音唤醒","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/66 语音识别.md","filePath":"frontend/66 语音识别.md"}'),l={name:"frontend/66 语音识别.md"};function o(t,s,c,r,i,y){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="语音唤醒" tabindex="-1">语音唤醒 <a class="header-anchor" href="#语音唤醒" aria-label="Permalink to &quot;语音唤醒&quot;">​</a></h1><p>比如说“小爱同学”&quot;天猫精灵“”小度小度“，就能唤醒语音程序，然后就可以跟它沟通了。</p><p>要在浏览器端实现语音关键词唤醒，您可以使用Web Speech API和SpeechRecognition库。 以下是一个使用SpeechRecognition库实现语音唤醒的简单示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;script type=&quot;text/javascript&quot;&gt;</span></span>
