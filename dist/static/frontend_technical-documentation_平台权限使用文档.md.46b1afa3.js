import{_ as a,o as n,c as l,O as p}from"./chunks/framework.d9e2f5d0.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/technical-documentation/平台权限使用文档.md","filePath":"frontend/technical-documentation/平台权限使用文档.md"}'),o={name:"frontend/technical-documentation/平台权限使用文档.md"};function e(t,s,c,r,E,y){return n(),l("div",null,s[0]||(s[0]=[p(`<blockquote><p>权限要求:配置了权限则根据权限显示，若不配置，则说明此功能不控制权限，需要一直显示。</p></blockquote><h3 id="使用流程" tabindex="-1">使用流程 <a class="header-anchor" href="#使用流程" aria-label="Permalink to &quot;使用流程&quot;">​</a></h3><h4 id="创建权限" tabindex="-1">创建权限 <a class="header-anchor" href="#创建权限" aria-label="Permalink to &quot;创建权限&quot;">​</a></h4><p>打开<code>系统管理</code> =&gt; <code>系统配置</code> =&gt; <code>权限配置</code>tab页，建立对应的权限。权限解释如下</p><ol><li>菜单页面</li></ol><p>即待配置的菜单</p><ol start="2"><li>tab开关</li></ol><p>控制对应的权限是否挂载在tab页面。以前的权限是不区分tab，后面因为迭代，所以加上了这个功能。后期看产品需求用于决定权限是否需要区分tab</p><ol start="3"><li>配置类型</li></ol><ul><li>菜单功能 对应页面的按钮权限</li><li>Tab页面  对应页面的Tab权限</li><li>筛选项    对应页面的筛选项权限(一般用于控制数据组的查询条件)</li></ul><ol start="4"><li>权限类型</li></ol><ul><li><p>菜单功能</p><pre><code>  配置对应操作类型(可自定义新增)，请求方式及请求接口地址
...
<span class="line"><span style="color:#24292E;">    },</span></span>
<span class="line"><span style="color:#24292E;">	}</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><br>`,40)]))}const u=a(o,[["render",e]]);export{d as __pageData,u as default};
