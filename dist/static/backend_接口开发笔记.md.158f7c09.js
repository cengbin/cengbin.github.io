import{_ as n,o as a,c as e,O as o}from"./chunks/framework.d9e2f5d0.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"backend/接口开发笔记.md","filePath":"backend/接口开发笔记.md"}'),t={name:"backend/接口开发笔记.md"};function l(p,s,c,u,r,q){return a(),e("div",null,s[0]||(s[0]=[o(`<h2 id="分页接口返回数据设计" tabindex="-1">分页接口返回数据设计： <a class="header-anchor" href="#分页接口返回数据设计" aria-label="Permalink to &quot;分页接口返回数据设计：&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,2)]))}const y=n(t,[["render",l]]);export{d as __pageData,y as default};
