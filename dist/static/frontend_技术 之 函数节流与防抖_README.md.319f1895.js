import{_ as n,o as a,c as e,O as l}from"./chunks/framework.d9e2f5d0.js";const u=JSON.parse('{"title":"函数节流与函数防抖","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/技术 之 函数节流与防抖/README.md","filePath":"frontend/技术 之 函数节流与防抖/README.md"}'),p={name:"frontend/技术 之 函数节流与防抖/README.md"};function t(o,s,c,i,r,y){return a(),e("div",null,s[0]||(s[0]=[l(`<h1 id="函数节流与函数防抖" tabindex="-1">函数节流与函数防抖 <a class="header-anchor" href="#函数节流与函数防抖" aria-label="Permalink to &quot;函数节流与函数防抖&quot;">​</a></h1><h2 id="节流-throttle" tabindex="-1">节流 throttle <a class="header-anchor" href="#节流-throttle" aria-label="Permalink to &quot;节流 throttle&quot;">​</a></h2><p>节流(Throttle):函数间隔一段时间后才能再触发，避免某些函数触发频率过高，比如滚动条滚动事件触发的函数。</p><h3 id="应用场景" tabindex="-1">应用场景 <a class="header-anchor" href="#应用场景" aria-label="Permalink to &quot;应用场景&quot;">​</a></h3><ul><li>鼠标不断点击触发，click（单位时间内只触发一次）</li><li>监听页面滚动事件，当滚动到某一个div时给div添加动画</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;body&gt;</span></span>
...
<span class="line"><span style="color:#24292e;">    }, 300))</span></span>
<span class="line"><span style="color:#24292e;">  &lt;/script&gt;</span></span>
<span class="line"><span style="color:#24292e;">&lt;/body&gt;</span></span></code></pre></div>`,13)]))}const g=n(p,[["render",t]]);export{u as __pageData,g as default};
