import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.0f4e1e9e.js";const w=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/45 安全沙箱(Sandboxes)/README.md","filePath":"frontend/45 安全沙箱(Sandboxes)/README.md"}'),l={name:"frontend/45 安全沙箱(Sandboxes)/README.md"},p=e(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">function foo(){</span></span>
