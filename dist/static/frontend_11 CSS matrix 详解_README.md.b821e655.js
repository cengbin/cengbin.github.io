import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.0f4e1e9e.js";const p="/static/a.0ec79bd9.jpg",f=JSON.parse('{"title":"CSS matrix 详解","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/11 CSS matrix 详解/README.md","filePath":"frontend/11 CSS matrix 详解/README.md"}'),l={name:"frontend/11 CSS matrix 详解/README.md"},o=e(`<h1 id="css-matrix-详解" tabindex="-1">CSS matrix 详解 <a class="header-anchor" href="#css-matrix-详解" aria-label="Permalink to &quot;CSS matrix 详解&quot;">​</a></h1><p>一个元素渲染后就可以得到一张位图，然后对这个位图上每一点进行变换，就可以得到新的一张位图，从而产生了视觉上的平移translate、旋转rotate、缩放scale、拉伸skew 等效果。这一切都是变换矩阵的功劳。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">selector {</span></span>
