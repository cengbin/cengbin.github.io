import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.0f4e1e9e.js";const l="/static/1.4aa2464a.jpg",p="/static/2.b77f116d.jpg",_=JSON.parse('{"title":"深入理解 JavaScript 闭包","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/详解 之 闭包/README.md","filePath":"frontend/详解 之 闭包/README.md"}'),o={name:"frontend/详解 之 闭包/README.md"},t=e(`<h1 id="深入理解-javascript-闭包" tabindex="-1">深入理解 JavaScript 闭包 <a class="header-anchor" href="#深入理解-javascript-闭包" aria-label="Permalink to &quot;深入理解 JavaScript 闭包&quot;">​</a></h1><h2 id="_1-前言" tabindex="-1">1. 前言 <a class="header-anchor" href="#_1-前言" aria-label="Permalink to &quot;1. 前言&quot;">​</a></h2><p>面试的时候常常会有面试官会问：谈谈你对闭包的理解？</p><p>首先回答问题要有清晰的思路和逻辑顺序，如：</p><ol><li>描述问题产生的背景。</li><li>如何解决的问题。</li><li>有什么结果。</li></ol><p>比如回答对闭包的理解可以按：</p><ol><li>为什么会有闭包？</li><li>闭包是如何设计的？</li><li>闭包的应用场景。</li></ol><p>我觉得按这样的思路回答问题，比按<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Closures" target="_blank" rel="noreferrer">MDN</a>上的解释说一遍回答“闭包（closure）是一个函数以及其捆绑的周边环境状态（lexical environment，词法环境）的引用的组合”要好。</p><h2 id="_2-为什么会有闭包" tabindex="-1">2. 为什么会有闭包？ <a class="header-anchor" href="#_2-为什么会有闭包" aria-label="Permalink to &quot;2. 为什么会有闭包？&quot;">​</a></h2><p>在<a href="http://en.wikipedia.org/wiki/Stack-oriented_programming_language" target="_blank" rel="noreferrer">面向堆栈的编程语言</a>中，函数的局部变量都是保存在栈上的，每当函数激活的时候，这些变量和函数参数都会压入到该堆栈上。</p><p>当函数返回的时候，这些参数又会从栈中移除。这种模型对将函数作为函数式值使用的时候有很大的限制（比方说，作为返回值从父函数中返回）。绝大部分情况下，问题会出现在当函数有自由变量的时候。</p><p>在ECMAScript中，函数是可以封装在父函数中的，并<strong>可以使用父函数上下文的变量</strong>。这个特性会引发Funarg问题。</p><h3 id="funarg-问题" tabindex="-1">Funarg 问题 <a class="header-anchor" href="#funarg-问题" aria-label="Permalink to &quot;Funarg 问题&quot;">​</a></h3><p>自由变量是指<strong>在函数中使用</strong>的，但既<strong>不是函数参数</strong>也<strong>不是函数的局部变量</strong>的变量</p><p>示例1：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">  function foo() {</span></span>
