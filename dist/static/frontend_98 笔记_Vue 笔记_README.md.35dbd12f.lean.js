import{_ as n,o as e,c as a,O as l}from"./chunks/framework.d9e2f5d0.js";const p="/static/781589-20210819154746534-814249557.1f3dee1b.png",h=JSON.parse('{"title":"Vue 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/98 笔记/Vue 笔记/README.md","filePath":"frontend/98 笔记/Vue 笔记/README.md"}'),t={name:"frontend/98 笔记/Vue 笔记/README.md"};function o(c,s,i,r,d,y){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="vue-笔记" tabindex="-1">Vue 笔记 <a class="header-anchor" href="#vue-笔记" aria-label="Permalink to &quot;Vue 笔记&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 未匹配到路由，则重定向到404页面</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,24)]))}const v=n(t,[["render",o]]);export{h as __pageData,v as default};
