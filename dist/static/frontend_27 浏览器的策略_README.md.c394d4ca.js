import{_ as a,o as e,c as n,O as l}from"./chunks/framework.d9e2f5d0.js";const y=JSON.parse('{"title":"浏览器的策略","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/27 浏览器的策略/README.md","filePath":"frontend/27 浏览器的策略/README.md"}'),t={name:"frontend/27 浏览器的策略/README.md"};function p(o,s,r,c,i,h){return e(),n("div",null,s[0]||(s[0]=[l(`<h1 id="浏览器的策略" tabindex="-1">浏览器的策略 <a class="header-anchor" href="#浏览器的策略" aria-label="Permalink to &quot;浏览器的策略&quot;">​</a></h1><h2 id="_1-浏览器的同源策略" tabindex="-1">1. 浏览器的同源策略 <a class="header-anchor" href="#_1-浏览器的同源策略" aria-label="Permalink to &quot;1. 浏览器的同源策略&quot;">​</a></h2><h3 id="_1-1-什么是同源策略" tabindex="-1">1.1 什么是同源策略 <a class="header-anchor" href="#_1-1-什么是同源策略" aria-label="Permalink to &quot;1.1 什么是同源策略&quot;">​</a></h3><h3 id="_1-2-解决跨域" tabindex="-1">1.2 解决跨域 <a class="header-anchor" href="#_1-2-解决跨域" aria-label="Permalink to &quot;1.2 解决跨域&quot;">​</a></h3><h3 id="_1-2-1前端解决" tabindex="-1">1.2.1前端解决 <a class="header-anchor" href="#_1-2-1前端解决" aria-label="Permalink to &quot;1.2.1前端解决&quot;">​</a></h3><p>通过没有同源策略限制的<code>&lt;script/&gt;</code>、<code>&lt;img/&gt;</code>等等标签发起一个请求</p><h4 id="jsonp" tabindex="-1">JSONP <a class="header-anchor" href="#jsonp" aria-label="Permalink to &quot;JSONP&quot;">​</a></h4><p>“JSON with Padding”(JSONP)是一种欺骗web浏览器的方法，它使用<code>&lt;script&gt;</code>标签来执行请求，该标签使用SRC属性来发出特殊的API请求。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">function jsonp(req) {</span></span>
