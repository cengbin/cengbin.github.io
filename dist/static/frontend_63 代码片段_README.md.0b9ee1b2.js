import{_ as n,o as a,c as e,O as l}from"./chunks/framework.d9e2f5d0.js";const p="/static/640.76b22e50.gif",o="/static/WX20240606-093541@2x.0db97dba.png",g=JSON.parse('{"title":"前端代码片段","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/63 代码片段/README.md","filePath":"frontend/63 代码片段/README.md"}'),t={name:"frontend/63 代码片段/README.md"};function c(i,s,r,d,y,u){return a(),e("div",null,s[0]||(s[0]=[l(`<h1 id="前端代码片段" tabindex="-1">前端代码片段 <a class="header-anchor" href="#前端代码片段" aria-label="Permalink to &quot;前端代码片段&quot;">​</a></h1><h2 id="_1-快速打开官网" tabindex="-1">1. 快速打开官网 <a class="header-anchor" href="#_1-快速打开官网" aria-label="Permalink to &quot;1. 快速打开官网&quot;">​</a></h2><p>当你想查看第三方库的主页和代码仓库时，你可以使用一下命令快速打开：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 打开主页</span></span>
...
<span class="line"><span style="color:#24292e;">    .replace(/\\b(\\d)\\b/g, &#39;0$1&#39;)</span></span></code></pre></div><p>如果你想显示“刚刚”、“5分钟前”之类的内容，可以尝试 timeago.js 库。</p><h2 id="_3-文件下载" tabindex="-1">3. 文件下载 <a class="header-anchor" href="#_3-文件下载" aria-label="Permalink to &quot;3. 文件下载&quot;">​</a></h2><p>使用 <code>a</code> 标签的 <code>download</code> 属性，同源才能触发下载，IE 不支持，移动端兼容性也不太好。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;a href=&quot;/path/to/file&quot; download&gt;Download&lt;/a&gt;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">&lt;a href=&quot;/path/to/file&quot; download&gt;Download&lt;/a&gt;</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 或者 js 临时生成 a</span></span>
...
<span class="line"><span style="color:#24292e;">window.URL.revokeObjectURL(url);</span></span></code></pre></div><h2 id="_4-多行省略号" tabindex="-1">4. 多行省略号 <a class="header-anchor" href="#_4-多行省略号" aria-label="Permalink to &quot;4. 多行省略号&quot;">​</a></h2><p>单行或多行截断显示省略号，很常用的 CSS 片段。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">.truncate {</span></span>
...
<span class="line"><span style="color:#24292e;">  overflow: hidden;</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h2 id="_5-选中最后几个元素" tabindex="-1">5. 选中最后几个元素 <a class="header-anchor" href="#_5-选中最后几个元素" aria-label="Permalink to &quot;5. 选中最后几个元素&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 前三个</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p><img src="`+o+`" alt="图片"></p><h2 id="_6-滚动条样式" tabindex="-1">6. 滚动条样式 <a class="header-anchor" href="#_6-滚动条样式" aria-label="Permalink to &quot;6. 滚动条样式&quot;">​</a></h2><p>自定义滚动条样式也是很常见的需求，除了通过样式，也可以通过第三方库（如 better-scroll 等）来实现自定义滚动条样式。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">/*定义滚动条高宽及背景 高宽分别对应横竖滚动条的尺寸*/</span></span>
...
<span class="line"><span style="color:#24292e;">document.body.style.removeProperty(&#39;overflow&#39;);</span></span></code></pre></div><h2 id="_9-读取mp3文件的信息" tabindex="-1">9. 读取mp3文件的信息 <a class="header-anchor" href="#_9-读取mp3文件的信息" aria-label="Permalink to &quot;9. 读取mp3文件的信息&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 监听文件输入字段的变化</span></span>
...
<span class="line"><span style="color:#24292e;">});</span></span></code></pre></div><h2 id="_10-css使页面不滚动" tabindex="-1">10. CSS使页面不滚动 <a class="header-anchor" href="#_10-css使页面不滚动" aria-label="Permalink to &quot;10. CSS使页面不滚动&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">.noscroll,.noscroll body{</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h2 id="_11-【奖励】增加、删除" tabindex="-1">11. 【奖励】增加、删除 <a class="header-anchor" href="#_11-【奖励】增加、删除" aria-label="Permalink to &quot;11. 【奖励】增加、删除&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;div v-for=&quot;(reward,index) in info.rewards&quot; :key=&quot;index&quot; class=&quot;condition-group&quot;&gt;</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	}</span></span>
<span class="line"><span style="color:#e1e4e8;">},</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">&lt;div v-for=&quot;(reward,index) in info.rewards&quot; :key=&quot;index&quot; class=&quot;condition-group&quot;&gt;</span></span>
...
<span class="line"><span style="color:#24292e;">	}</span></span>
<span class="line"><span style="color:#24292e;">},</span></span></code></pre></div><h2 id="_12-将文本复制到剪贴板" tabindex="-1">12. 将文本复制到剪贴板 <a class="header-anchor" href="#_12-将文本复制到剪贴板" aria-label="Permalink to &quot;12. 将文本复制到剪贴板&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">navigator.clipboard.writeText(&#39;Text to copy&#39;)</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">navigator.clipboard.writeText(&#39;Text to copy&#39;)</span></span></code></pre></div><p>通过使用 Clipboard API 以编程方式将文本复制到剪贴板。这是一种最新的复制方法，可让文本复制变得无缝且高效（但目前各大浏览器支持度还不是很高，需要考虑兼容性问题）。</p><h2 id="_13-离开页面弹出确认对话框" tabindex="-1">13. 离开页面弹出确认对话框 <a class="header-anchor" href="#_13-离开页面弹出确认对话框" aria-label="Permalink to &quot;13. 离开页面弹出确认对话框&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">window.onbeforeunload =（）=&gt;‘你确定要离开吗？</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">window.onbeforeunload =（）=&gt;‘你确定要离开吗？</span></span></code></pre></div><p>这行代码与 window 的 onbeforeunload 事件挂钩，当用户离开页面时会弹出一个确认对话框，一般用于防止用户因未保存更改就关闭页面而导致数据丢失。</p><h2 id="_14-日志格式" tabindex="-1">14. 日志格式 <a class="header-anchor" href="#_14-日志格式" aria-label="Permalink to &quot;14. 日志格式&quot;">​</a></h2><p>日志的格式应该统一，以便于阅读和解析。一个常见的日志格式如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">［时间戳］【日志等级］［消息内容］［错误堆栈］</span></span>
<span class="line"><span style="color:#e1e4e8;">例如：</span></span>
<span class="line"><span style="color:#e1e4e8;">[2024-04-01T12:00:00.000Z] [ERROR] Failed to load.</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">［时间戳］【日志等级］［消息内容］［错误堆栈］</span></span>
<span class="line"><span style="color:#24292e;">例如：</span></span>
<span class="line"><span style="color:#24292e;">[2024-04-01T12:00:00.000Z] [ERROR] Failed to load.</span></span></code></pre></div><p><a href="https://mp.weixin.qq.com/s/778hr32KnLFEw7oBNt38sg" target="_blank" rel="noreferrer">N 个值得一看的前端代码片段</a></p>`,48)]))}const b=n(t,[["render",c]]);export{g as __pageData,b as default};
