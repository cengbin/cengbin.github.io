import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.0f4e1e9e.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/technical-documentation/中台子项目权限使用.md","filePath":"frontend/technical-documentation/中台子项目权限使用.md"}'),p={name:"frontend/technical-documentation/中台子项目权限使用.md"},o=l(`<p><a name="4e800279"></a></p><h3 id="中台权限相关" tabindex="-1">中台权限相关 <a class="header-anchor" href="#中台权限相关" aria-label="Permalink to &quot;中台权限相关&quot;">​</a></h3><blockquote><p>路由配置表中meta字段新增auth字段，用于判断是否需要权限控制(白名单的路由除外)</p></blockquote><p><a name="0fea7c47"></a></p><h4 id="数据结构" tabindex="-1">数据结构 <a class="header-anchor" href="#数据结构" aria-label="Permalink to &quot;数据结构&quot;">​</a></h4><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">{</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div>`,26),e=[o];function t(c,E,r,y,i,u){return n(),a("div",null,e)}const d=s(p,[["render",t]]);export{b as __pageData,d as default};
