import{_ as e,o as s,c as a,Q as n}from"./chunks/framework.0f4e1e9e.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/9 笔记/Webpack.md","filePath":"frontend/9 笔记/Webpack.md"}'),p={name:"frontend/9 笔记/Webpack.md"},o=n(`<h2 id="指定打开浏览器时的导航页面和参数配置" tabindex="-1">指定打开浏览器时的导航页面和参数配置 <a class="header-anchor" href="#指定打开浏览器时的导航页面和参数配置" aria-label="Permalink to &quot;指定打开浏览器时的导航页面和参数配置&quot;">​</a></h2><p>查看webpack 打开浏览器默认带上参数的配置。</p><p><a href="https://v4.webpack.docschina.org/configuration/dev-server/#devserver-openpage" target="_blank" rel="noreferrer">https://v4.webpack.docschina.org/configuration/dev-server/#devserver-openpage</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">devServer: {</span></span>
