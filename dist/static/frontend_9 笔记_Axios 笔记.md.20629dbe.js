import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.0f4e1e9e.js";const f=JSON.parse('{"title":"Axios 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/9 笔记/Axios 笔记.md","filePath":"frontend/9 笔记/Axios 笔记.md"}'),p={name:"frontend/9 笔记/Axios 笔记.md"},l=a(`<h1 id="axios-笔记" tabindex="-1">Axios 笔记 <a class="header-anchor" href="#axios-笔记" aria-label="Permalink to &quot;Axios 笔记&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">const instance = axios.create({</span></span>
