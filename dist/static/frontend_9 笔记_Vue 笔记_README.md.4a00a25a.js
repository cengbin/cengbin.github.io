import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.0f4e1e9e.js";const p="/static/781589-20210819154746534-814249557.1f3dee1b.png",g=JSON.parse('{"title":"Vue 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/9 笔记/Vue 笔记/README.md","filePath":"frontend/9 笔记/Vue 笔记/README.md"}'),l={name:"frontend/9 笔记/Vue 笔记/README.md"},t=e(`<h1 id="vue-笔记" tabindex="-1">Vue 笔记 <a class="header-anchor" href="#vue-笔记" aria-label="Permalink to &quot;Vue 笔记&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 未匹配到路由，则重定向到404页面</span></span>
