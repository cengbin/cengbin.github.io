import{_ as s,o as e,c as a,Q as n}from"./chunks/framework.0f4e1e9e.js";const g=JSON.parse('{"title":"Prettier 实践","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/1 前端工程化/3 开发/3 规范化/ESLint+Prettier/Prettier实践.md","filePath":"frontend/1 前端工程化/3 开发/3 规范化/ESLint+Prettier/Prettier实践.md"}'),p={name:"frontend/1 前端工程化/3 开发/3 规范化/ESLint+Prettier/Prettier实践.md"},l=n(`<h1 id="prettier-实践" tabindex="-1">Prettier 实践 <a class="header-anchor" href="#prettier-实践" aria-label="Permalink to &quot;Prettier 实践&quot;">​</a></h1><h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to &quot;简介&quot;">​</a></h2><p>ESLint 用来进行代码质量的校验。例如：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// bad</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span>
<span class="line"><span style="color:#24292e;">console.log(a)</span></span></code></pre></div><p>实际中通常 ESLint 与 Prettier 配合使用。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><p>npm i --save-dev prettier</p><p>配合ESLint检测代码风格</p><p>npm i --save-dev eslint-plugin-prettier</p><p>eslint-plugin-prettier 是一个插件，会调用prettier对你的代码风格进行检查，其原理是先使用prettier对你的代码进行格式化，然后与格式化之前的代码进行对比，如果过出现了不一致，这个地方就会被prettier进行标记。</p><p>接下来，我们需要在rules中添加，&quot;prettier/prettier&quot;: &quot;error&quot;，表示被prettier标记的地方抛出错误信息。</p><p>如果与已存在的插件冲突怎么办 (解决 eslint 和 prettier 冲突)</p><p>npm i -D eslint-config-prettier</p><p>通过使用eslint-config-prettier配置，能够关闭一些不必要的或者是与prettier冲突的lint选项。这样我们就不会看到一些error同时出现两次。使用的时候需要确保，这个配置在extends的最后一项。</p><p>// .eslintrc.js</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
<span class="line"><span style="color:#e1e4e8;">	 ...</span></span>
<span class="line"><span style="color:#e1e4e8;">    extends: [</span></span>
<span class="line"><span style="color:#e1e4e8;">      &#39;standard&#39;, //使用 standard 做代码规范</span></span>
<span class="line"><span style="color:#e1e4e8;">      &quot;prettier&quot;, //使用 eslint-config-prettier 的规则进行代码检查</span></span>
<span class="line"><span style="color:#e1e4e8;">    ],</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	    ...</span></span>
<span class="line"><span style="color:#e1e4e8;">	    &quot;prettier/prettier&quot;: &quot;error&quot;, // 被prettier标记的地方报error</span></span>
<span class="line"><span style="color:#e1e4e8;">  	},</span></span>
<span class="line"><span style="color:#e1e4e8;">  	...</span></span>
<span class="line"><span style="color:#e1e4e8;">}</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">{</span></span>
<span class="line"><span style="color:#24292e;">	 ...</span></span>
<span class="line"><span style="color:#24292e;">    extends: [</span></span>
<span class="line"><span style="color:#24292e;">      &#39;standard&#39;, //使用 standard 做代码规范</span></span>
<span class="line"><span style="color:#24292e;">      &quot;prettier&quot;, //使用 eslint-config-prettier 的规则进行代码检查</span></span>
<span class="line"><span style="color:#24292e;">    ],</span></span>
...
<span class="line"><span style="color:#24292e;">	    ...</span></span>
<span class="line"><span style="color:#24292e;">	    &quot;prettier/prettier&quot;: &quot;error&quot;, // 被prettier标记的地方报error</span></span>
<span class="line"><span style="color:#24292e;">  	},</span></span>
<span class="line"><span style="color:#24292e;">  	...</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>我们统一使用prettier的风格是为了团队和睦，世界和平，我们做出的牺牲都是必要的。而且prettier的样式风格已经在很多大型开源项目中被采用，比如react、webpack、babel。</p><h3 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to &quot;参考&quot;">​</a></h3><p><a href="https://juejin.cn/post/6844903621805473800?searchId=2023101113021452187A2E209592665B00" target="_blank" rel="noreferrer">使用ESLint+Prettier来统一前端代码风格</a></p>`,26),t=[l];function o(r,c,i,u,d,y){return e(),a("div",null,t)}const b=s(p,[["render",o]]);export{g as __pageData,b as default};
