import{_ as a,o as n,c as e,O as p}from"./chunks/framework.d9e2f5d0.js";const l="/static/a.0ec79bd9.jpg",m=JSON.parse('{"title":"CSS matrix 详解","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/详解 之 CSS matrix/README.md","filePath":"frontend/详解 之 CSS matrix/README.md"}'),o={name:"frontend/详解 之 CSS matrix/README.md"};function t(c,s,r,i,d,h){return n(),e("div",null,s[0]||(s[0]=[p(`<h1 id="css-matrix-详解" tabindex="-1">CSS matrix 详解 <a class="header-anchor" href="#css-matrix-详解" aria-label="Permalink to &quot;CSS matrix 详解&quot;">​</a></h1><p>一个元素渲染后就可以得到一张位图，然后对这个位图上每一点进行变换，就可以得到新的一张位图，从而产生了视觉上的平移translate、旋转rotate、缩放scale、拉伸skew 等效果。这一切都是变换矩阵的功劳。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">selector {</span></span>
...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">transform: matrix(1, 0.577, 0.364, 1, 0, 0)</span></span></code></pre></div><p>矩阵可以对向量进行转换?</p><h3 id="参考链接" tabindex="-1">参考链接 <a class="header-anchor" href="#参考链接" aria-label="Permalink to &quot;参考链接&quot;">​</a></h3><ul><li><p><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/transform-function" target="_blank" rel="noreferrer">https://developer.mozilla.org/zh-CN/docs/Web/CSS/transform-function</a></p></li><li><p><a href="https://juejin.cn/post/6844903616629719054" target="_blank" rel="noreferrer">理解 CSS3 transform 中的 matrix</a></p></li></ul>`,29)]))}const b=a(o,[["render",t]]);export{m as __pageData,b as default};
