import{_ as e,o as n,c as a,O as l}from"./chunks/framework.d9e2f5d0.js";const t="/static/图2.59a5a621.png",u=JSON.parse('{"title":"微前端","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/3 前端架构/微前端架构设计/README.md","filePath":"frontend/3 前端架构/微前端架构设计/README.md"}'),p={name:"frontend/3 前端架构/微前端架构设计/README.md"};function o(c,s,r,i,d,h){return n(),a("div",null,s[0]||(s[0]=[l('<h1 id="微前端" tabindex="-1">微前端 <a class="header-anchor" href="#微前端" aria-label="Permalink to &quot;微前端&quot;">​</a></h1><h4 id="目录" tabindex="-1">目录 <a class="header-anchor" href="#目录" aria-label="Permalink to &quot;目录&quot;">​</a></h4><ol><li>前言</li><li>什么是微前端</li><li>微前端的好处</li><li>微前端的实现方式</li><li>微前端的落地实现</li></ol><h2 id="_1、前言" tabindex="-1">1、前言 <a class="header-anchor" href="#_1、前言" aria-label="Permalink to &quot;1、前言&quot;">​</a></h2><p>分享内容的均是基于我自己的理解和认识，如果有什么不对的地方大家随时给我纠正。</p><h2 id="_2、什么是微前端" tabindex="-1">2、什么是微前端 <a class="header-anchor" href="#_2、什么是微前端" aria-label="Permalink to &quot;2、什么是微前端&quot;">​</a></h2><p>首先我们聊一下就是什么是微前端。为什么出现微前端？</p><p>近些年来，后端微服务爆炸式地流行起来，许多组织使用这种体系结构风格来避免大型、单片的后端限制。用这种风格来开发后端项目。虽然关于这种构建服务器端软件的风格已经比较成熟，但是前端却没有太多。</p><p>有时我们想构建一个渐进的或响应性的web应用程序，但是找不到一个容易的地方开始将这些新特性集成到现有代码中。也许我们想开始使用新的JavaScript语言特性(或者可以编译成JavaScript的多种语言中的一种)，但是我们还是无法将必要的构建工具融入现有的构建过程。或者有时只是想要扩展您的开发，以便多个团队可以同时处理单个产品，但是现有整体中的耦合性和复杂性意味着每个人都在踩着彼此的脚。这些都是真正的问题，会对有效地提供高质量项目产生负面影响。</p><p>带着这些问题，越来越多的人开始关注复杂的现代web开发所必需的整体架构和组织结构。我们也看到了一些模式出现，它们将前端巨石项目分解成更小、更简单的块，这些块可以独立开发、测试和部署，同时在客户看来仍然是一个单一的内聚产品。我们称之为微前沿技术。</p><p>我们将其定义为:</p><blockquote><p>“将独立可交付的前端应用程序组成一个更大的整体的架构风格” 与技术无关，做到技术隔离。</p></blockquote><h2 id="_3、微前端的好处" tabindex="-1">3、微前端的好处 <a class="header-anchor" href="#_3、微前端的好处" aria-label="Permalink to &quot;3、微前端的好处&quot;">​</a></h2><h4 id="独立部署" tabindex="-1">独立部署 <a class="header-anchor" href="#独立部署" aria-label="Permalink to &quot;独立部署&quot;">​</a></h4><p>与微服务一样，微前端的独立可部署性是关键。这减少了给定部署的范围，从而减少了相关的风险。不管前端代码在哪里托管的，每个微前端都应该有自己的连续交付管道，在生产过程中构建、测试和部署它。我们应该能够在部署每个微前端项目时，很少考虑到其他代码库当前状态。不管旧的，还是隔壁老王的团队将一个半成品或过时的特性推到他们的主分支中，这都不重要。因为各自的项目可以独立部署，这个该由构建和维护它的团队来决定。而不是别的开发人员或开发团队。</p><p>就像下面这张图，每个团队项目拥有自己的项目仓库，可以对项目构建，测试，部署，并且最终发布组成一个大的应用程序。</p><p><img src="'+t+`" alt="每个微型前端都独立部署到生产中"></p><h4 id="增量升级" tabindex="-1">增量升级 <a class="header-anchor" href="#增量升级" aria-label="Permalink to &quot;增量升级&quot;">​</a></h4><p>在我们的项目中正在使用那些旧的过时的技术，或者是在交付压力下编写的代码所拖累，而现在已经到了完全要重写的时候了。为了避免完全重写的危险，我们更愿意一点一点地扼杀旧的应用程序，同时可以继续交付高质量的项目并使用新特性，而不被这个庞然大物的项目压垮。</p><h4 id="简单并且解耦的代码库" tabindex="-1">简单并且解耦的代码库 <a class="header-anchor" href="#简单并且解耦的代码库" aria-label="Permalink to &quot;简单并且解耦的代码库&quot;">​</a></h4><p>每个单独的微前端的源代码都比单个整体前端的源代码小得多。对于我们开发人员来说，这些较小的代码库往往更简单、更容易使用。特别是，我们避免了组件之间不应该相互了解的非故意和不适当耦合所带来的复杂性。</p><p>就比如说A团队有一块和B团队有一块的需求差不多，但是B团队要对A团队的代码上做一些处理才能满足B团队的需求。要嘛高度抽象出公共业务组件，要嘛就在项目内开发。避免像蜘蛛网一样的项目之间引用。</p><h4 id="自治团队" tabindex="-1">自治团队 <a class="header-anchor" href="#自治团队" aria-label="Permalink to &quot;自治团队&quot;">​</a></h4><p>作为将我们的代码库和发布周期解耦的好处，就是我们可以拥有完全独立的团队开发，他们可以拥有产品的一部分，从构思到生产，甚至更远。这使得团队能够快速有效地行动。为了实现这一点，我们的团队只需要围绕业务功能的垂直部分去开发，而不是围绕技术能力。一种简单的方法是根据最终用户将看到的内容划分产品，因此每个微前端封装应用程序的单个页面，并由单个团队端到端拥有。</p><h2 id="_4、微前端的实现方式" tabindex="-1">4、微前端的实现方式 <a class="header-anchor" href="#_4、微前端的实现方式" aria-label="Permalink to &quot;4、微前端的实现方式&quot;">​</a></h2><h4 id="通过构建时集成" tabindex="-1">通过构建时集成 <a class="header-anchor" href="#通过构建时集成" aria-label="Permalink to &quot;通过构建时集成&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
