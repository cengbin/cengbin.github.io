import{_ as i,C as a,o as y,c as E,k as e,a as s,H as n,Q as p}from"./chunks/framework.0f4e1e9e.js";const k=JSON.parse('{"title":"Element UI 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/98 笔记/Element UI 笔记.md","filePath":"frontend/98 笔记/Element UI 笔记.md"}'),u={name:"frontend/98 笔记/Element UI 笔记.md"},d=p(`<h1 id="element-ui-笔记" tabindex="-1">Element UI 笔记 <a class="header-anchor" href="#element-ui-笔记" aria-label="Permalink to &quot;Element UI 笔记&quot;">​</a></h1><h2 id="组件库全局设置" tabindex="-1">组件库全局设置 <a class="header-anchor" href="#组件库全局设置" aria-label="Permalink to &quot;组件库全局设置&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">Vue.use(Element, {</span></span>
...
<span class="line"><span style="color:#24292e;">});</span></span></code></pre></div>`,43);function h(q,m,v,F,b,C){const o=a("form-item"),t=a("el-from"),l=a("el-select"),c=a("el-input"),r=a("el-form-item");return y(),E("div",null,[d,e("p",null,[s("如果要调用resetFields方法，必须要在"),n(o),s("组件上设置prop属性。")]),e("p",null,[s("当"),n(t),s("设置了size=‘small’的时候，"),n(l),s(),n(c),s(" 元素必须要放到"),n(r),s("下才能生效，否者只能在"),n(l),s("元素上单独设置size属性才能生效。")]),g])}const B=i(u,[["render",h]]);export{k as __pageData,B as default};
