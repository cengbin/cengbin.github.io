import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.0f4e1e9e.js";const g=JSON.parse('{"title":"多列照片墙实现","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/14 多列照片墙实现技术/README.md","filePath":"frontend/14 多列照片墙实现技术/README.md"}'),p={name:"frontend/14 多列照片墙实现技术/README.md"},e=l(`<h1 id="多列照片墙实现" tabindex="-1">多列照片墙实现 <a class="header-anchor" href="#多列照片墙实现" aria-label="Permalink to &quot;多列照片墙实现&quot;">​</a></h1><h2 id="属性" tabindex="-1">属性 <a class="header-anchor" href="#属性" aria-label="Permalink to &quot;属性&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{</span></span>
