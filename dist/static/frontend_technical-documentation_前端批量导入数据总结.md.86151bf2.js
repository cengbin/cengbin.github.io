import{_ as s,o as e,c as n,Q as a}from"./chunks/framework.0f4e1e9e.js";const l="/static/excel_template.aad90f74.png",p="/static/excel_detail.fee43f64.png",o="/static/excel_edit.922ee7ea.png",_=JSON.parse('{"title":"前端批量导入excel数据总结","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/technical-documentation/前端批量导入数据总结.md","filePath":"frontend/technical-documentation/前端批量导入数据总结.md"}'),t={name:"frontend/technical-documentation/前端批量导入数据总结.md"},c=a('<h1 id="前端批量导入excel数据总结" tabindex="-1">前端批量导入excel数据总结 <a class="header-anchor" href="#前端批量导入excel数据总结" aria-label="Permalink to &quot;前端批量导入excel数据总结&quot;">​</a></h1><p>以批量导入【玩家+附件数据.xlsx】文件为例：</p><p><img src="'+l+`" alt=""></p><p>1、模板文件下载 与 读文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">if (command === &#39;download&#39;) {</span></span>
...
<span class="line"><span style="color:#24292e;">},</span></span></code></pre></div><p>3、展示文件详情</p><p><img src="`+p+'" alt=""></p><p>3.1 表单输入玩家ID进行搜索<br> 3.2 前端分页展示当前页+符合搜索条件的数据</p><p>4、支持表格中对行数据修改</p><p><img src="'+o+'" alt=""></p><p>4.1 点击编辑，编辑行数据<br> 4.2 点击确定，修改行数据<br> 4.3 修改后调用服务端验证数据是否正确<br> 4.4 效验成功更新本地缓存的数据</p>',18),r=[c];function i(d,y,h,u,f,g){return e(),n("div",null,r)}const k=s(t,[["render",i]]);export{_ as __pageData,k as default};
