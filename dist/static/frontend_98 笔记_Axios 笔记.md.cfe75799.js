import{_ as n,o as a,c as e,O as l}from"./chunks/framework.d9e2f5d0.js";const d=JSON.parse('{"title":"Axios 笔记","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/98 笔记/Axios 笔记.md","filePath":"frontend/98 笔记/Axios 笔记.md"}'),p={name:"frontend/98 笔记/Axios 笔记.md"};function t(o,s,c,r,i,y){return a(),e("div",null,s[0]||(s[0]=[l(`<h1 id="axios-笔记" tabindex="-1">Axios 笔记 <a class="header-anchor" href="#axios-笔记" aria-label="Permalink to &quot;Axios 笔记&quot;">​</a></h1><p>ajax.js</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">/**</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">export default ajax</span></span></code></pre></div>`,3)]))}const g=n(p,[["render",t]]);export{d as __pageData,g as default};
