import{_ as s,o as e,c as n,O as l}from"./chunks/framework.d9e2f5d0.js";const h=JSON.parse('{"title":"JavaScript模块及发展过程","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/1 前端工程化/1 模块化/JavaScript模块化.md","filePath":"frontend/1 前端工程化/1 模块化/JavaScript模块化.md"}'),p={name:"frontend/1 前端工程化/1 模块化/JavaScript模块化.md"};function o(t,a,c,i,r,d){return e(),n("div",null,a[0]||(a[0]=[l(`<h1 id="javascript模块及发展过程" tabindex="-1">JavaScript模块及发展过程 <a class="header-anchor" href="#javascript模块及发展过程" aria-label="Permalink to &quot;JavaScript模块及发展过程&quot;">​</a></h1><h3 id="目录" tabindex="-1">目录 <a class="header-anchor" href="#目录" aria-label="Permalink to &quot;目录&quot;">​</a></h3><ul><li>前言</li><li>模块化的理解</li><li>模块化规范</li><li>参考链接</li></ul><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在JavaScript发展初期就是为了实现简单的页面交互逻辑，寥寥数语即可；如今CPU、浏览器性能得到了极大的提升，很多页面逻辑迁移到了客户端（表单验证等），随着web2.0时代的到来，Ajax技术得到广泛应用，jQuery等前端库层出不穷，前端代码日益膨胀，此时在JS方面就会考虑使用模块化规范去管理。</p><h2 id="模块化的理解" tabindex="-1">模块化的理解 <a class="header-anchor" href="#模块化的理解" aria-label="Permalink to &quot;模块化的理解&quot;">​</a></h2><h3 id="_1-什么是模块" tabindex="-1">1.什么是模块？ <a class="header-anchor" href="#_1-什么是模块" aria-label="Permalink to &quot;1.什么是模块？&quot;">​</a></h3><ul><li>将一个复杂的程序依据一定的规则(规范)封装成几个块(文件), 并进行组合在一起</li><li>块的内部数据与实现是私有的, 只是向外部暴露一些接口(方法)与外部其它模块通信</li></ul><h3 id="_2-模块化的进化过程" tabindex="-1">2.模块化的进化过程 <a class="header-anchor" href="#_2-模块化的进化过程" aria-label="Permalink to &quot;2.模块化的进化过程&quot;">​</a></h3><ul><li>全局function模式 : 将不同的功能封装成不同的全局函数</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">function m1(){</span></span>
...
<span class="line"><span style="color:#24292e;">        name: &#39;我是一个umd模块&#39;</span></span>
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}))</span></span></code></pre></div><p>参考链接：<a href="https://juejin.cn/post/6844903927104667662" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903927104667662</a></p><h3 id="_5-es6模块化" tabindex="-1">5. ES6模块化 <a class="header-anchor" href="#_5-es6模块化" aria-label="Permalink to &quot;5. ES6模块化&quot;">​</a></h3><h4 id="概述" tabindex="-1">概述 <a class="header-anchor" href="#概述" aria-label="Permalink to &quot;概述&quot;">​</a></h4><p>在 ES6 前， 实现模块化使用的是 RequireJS 或者 seaJS（分别是基于 AMD 规范的模块化库， 和基于 CMD 规范的模块化库）。</p><p>ES6 引入了模块化，其设计思想是在编译时就能确定模块的依赖关系，以及输入和输出的变量。</p><p>ES6 的模块化分为导出（export） @与导入（import）两个模块。</p><h4 id="特点" tabindex="-1">特点 <a class="header-anchor" href="#特点" aria-label="Permalink to &quot;特点&quot;">​</a></h4><p>ES6 的模块自动开启严格模式，不管你有没有在模块头部加上 use strict;。</p><p>模块中可以导入和导出各种类型的变量，如函数，对象，字符串，数字，布尔值，类等。</p><p>每个模块都有自己的上下文，每一个模块内声明的变量都是局部变量，不会污染全局作用域。</p><p>每一个模块只加载一次（是单例的）， 若再去加载同目录下同文件，直接从内存中读取。</p><h4 id="参考链接" tabindex="-1">参考链接 <a class="header-anchor" href="#参考链接" aria-label="Permalink to &quot;参考链接&quot;">​</a></h4><ul><li><a href="https://segmentfault.com/a/1190000017466120" target="_blank" rel="noreferrer">https://segmentfault.com/a/1190000017466120</a></li><li><a href="https://juejin.cn/post/6844903961128861704" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903961128861704</a></li><li><a href="https://www.runoob.com/w3cnote/es6-module.html" target="_blank" rel="noreferrer">https://www.runoob.com/w3cnote/es6-module.html</a></li></ul>`,62)]))}const m=s(p,[["render",o]]);export{h as __pageData,m as default};
