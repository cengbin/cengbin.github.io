import{_ as a,o as n,c as e,O as p}from"./chunks/framework.d9e2f5d0.js";const l="/static/env.fca97fca.jpg",u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/44 使用NodeJS开发命令行工具/使用Node如何制作一个专业的命令行工具以及命令执行的原理.md","filePath":"frontend/44 使用NodeJS开发命令行工具/使用Node如何制作一个专业的命令行工具以及命令执行的原理.md"}'),o={name:"frontend/44 使用NodeJS开发命令行工具/使用Node如何制作一个专业的命令行工具以及命令执行的原理.md"};function c(i,s,t,r,d,g){return n(),e("div",null,s[0]||(s[0]=[p(`<p>使用Node开发一款命令行工具是一件比较有意思的事情。</p><h2 id="_1-命令行工具与环境变量-path" tabindex="-1">1.命令行工具与环境变量 PATH <a class="header-anchor" href="#_1-命令行工具与环境变量-path" aria-label="Permalink to &quot;1.命令行工具与环境变量 PATH&quot;">​</a></h2><p>使用 which 追根 pwd 、env 命令，发现它们实际执行的路径在某一个 bin 目录</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">binzengdeMacBook-Pro:~ bin.zeng$ which pwd</span></span>
...
<span class="line"><span style="color:#24292e;">console.log(options)</span></span></code></pre></div><h3 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to &quot;参考&quot;">​</a></h3><p><a href="https://mp.weixin.qq.com/s/TAj-dvEU8FeM6ifq34zanA" target="_blank" rel="noreferrer">https://mp.weixin.qq.com/s/TAj-dvEU8FeM6ifq34zanA</a></p>`,29)]))}const y=a(o,[["render",c]]);export{u as __pageData,y as default};
