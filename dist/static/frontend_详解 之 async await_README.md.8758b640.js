...
<span class="line"><span style="color:#24292e;">      })</span></span>
<span class="line"><span style="color:#24292e;">    })</span></span>
<span class="line"><span style="color:#24292e;">  })</span></span></code></pre></div><p>如上代码如果yield返回的是Promise 就会出现回调地狱的问题。</p><h2 id="es7-async-await" tabindex="-1">ES7 async await <a class="header-anchor" href="#es7-async-await" aria-label="Permalink to &quot;ES7 async await&quot;">​</a></h2><p>async await 语法的出现就是为了解决这种回调地狱的问题。</p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><ul><li>首先 async/await 是一种用于处理异步操作的语法糖，在ES2017中被引入，用于更简洁地编写基于Promise的链式回调代码。</li><li>使用 async/await 主要是避免了传统的回调函数或 Promise 链的嵌套。</li></ul><h2 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to &quot;参考&quot;">​</a></h2><p><a href="https://juejin.cn/post/7281535380590559243?searchId=202310310948531CA24C843535DA63EB62" target="_blank" rel="noreferrer">https://juejin.cn/post/7281535380590559243?searchId=202310310948531CA24C843535DA63EB62</a></p>`,17)]))}const v=n(p,[["render",o]]);export{g as __pageData,v as default};
