import{_ as a,o as s,c as e,O as l}from"./chunks/framework.d9e2f5d0.js";const u=JSON.parse('{"title":"关于Array.apply(null,类数组对象)","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/详解 之 Array.apply/README.md","filePath":"frontend/详解 之 Array.apply/README.md"}'),p={name:"frontend/详解 之 Array.apply/README.md"};function r(o,n,c,t,i,y){return s(),e("div",null,n[0]||(n[0]=[l(`<h1 id="关于array-apply-null-类数组对象" tabindex="-1">关于Array.apply(null,类数组对象) <a class="header-anchor" href="#关于array-apply-null-类数组对象" aria-label="Permalink to &quot;关于Array.apply(null,类数组对象)&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">let arr1 = new Array(2)</span></span>
...
<span class="line"><span style="color:#24292e;">console.log(arr4)</span></span></code></pre></div>`,2)]))}const g=a(p,[["render",r]]);export{u as __pageData,g as default};
