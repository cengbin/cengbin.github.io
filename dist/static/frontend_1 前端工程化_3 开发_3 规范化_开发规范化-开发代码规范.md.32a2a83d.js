import{_ as s,o as e,c as n,Q as a}from"./chunks/framework.0f4e1e9e.js";const h=JSON.parse('{"title":"开发规范化 之 开发代码规范","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/1 前端工程化/3 开发/3 规范化/开发规范化-开发代码规范.md","filePath":"frontend/1 前端工程化/3 开发/3 规范化/开发规范化-开发代码规范.md"}'),p={name:"frontend/1 前端工程化/3 开发/3 规范化/开发规范化-开发代码规范.md"},l=a(`<h1 id="开发规范化-之-开发代码规范" tabindex="-1">开发规范化 之 开发代码规范 <a class="header-anchor" href="#开发规范化-之-开发代码规范" aria-label="Permalink to &quot;开发规范化 之 开发代码规范&quot;">​</a></h1><h3 id="_1-1-代码质量规范" tabindex="-1">1.1 代码质量规范 <a class="header-anchor" href="#_1-1-代码质量规范" aria-label="Permalink to &quot;1.1 代码质量规范&quot;">​</a></h3><p>前端使用ESLint工具做代码质量检测。JavaScript代码应符合 ESLint 预定义的 eslint:recommended 编码规则。</p><h3 id="_1-1-1-eslint-实践" tabindex="-1">1.1.1 ESLint 实践 <a class="header-anchor" href="#_1-1-1-eslint-实践" aria-label="Permalink to &quot;1.1.1 ESLint 实践&quot;">​</a></h3><p><strong>安装：</strong></p><p><code>npm install --save-dev eslint@8.52.0</code></p><p><strong>使用：</strong></p><p>项目根目录添加.eslintrc.js文件，内容如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">module.exports = {</span></span>
...
<span class="line"><span style="color:#24292e;">},</span></span></code></pre></div><p>通过npm run eslint 进行代码检测。</p><p>通过npm run eslint:fix 进行代码自动修复。</p><p>至此ESLint基础配置就完成了。</p><h3 id="_1-1-2-vue项目实践" tabindex="-1">1.1.2 Vue项目实践 <a class="header-anchor" href="#_1-1-2-vue项目实践" aria-label="Permalink to &quot;1.1.2 Vue项目实践&quot;">​</a></h3><p>Vue 团队维护着 eslint-plugin-vue 项目，它是一个 ESLint 插件，会提供 SFC 相关规则的定义。Vue代码应符合&#39;plugin:vue/vue3-recommended&#39;编码规则。</p><p><strong>安装：</strong></p><p><code>npm install —save-dev eslint-plugin-vue@9.25.0</code></p><p><strong>使用：</strong></p><p>修改.eslintrc.js，如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">module.exports = {</span></span>
<span class="line"><span style="color:#e1e4e8;">	…</span></span>
...
<span class="line"><span style="color:#24292e;">	}</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><p>Vue <a href="https://eslint.vuejs.org/rules/" target="_blank" rel="noreferrer">规则列表</a></p><p>至此Vue项目的ESLint基础配置就完成了。</p><h3 id="_1-1-3-vite创建的vue项目" tabindex="-1">1.1.3 Vite创建的Vue项目 <a class="header-anchor" href="#_1-1-3-vite创建的vue项目" aria-label="Permalink to &quot;1.1.3 Vite创建的Vue项目&quot;">​</a></h3><p>如果想要再vite运行的时候自动检测eslint规范，并且在页面提示错误信息。</p><p><strong>安装：</strong></p><p><code>npm install —save-dev vite-plugin-eslint@1.8.1</code></p><p><strong>使用：</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { defineConfig } from &#39;vite&#39;</span></span>
