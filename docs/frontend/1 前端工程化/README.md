...
- **工程**：提供了一种**系统化**、**规范化**、**可量化**的**方法论**和**实践体系**。
...
前端项目开发流程大致可以分为：架构 -> 构建 -> 开发 -> 测试 -> 部署 -> 监控，我觉得可以从[模块化](./1%20模块化/README.md)、[组件化](./2%20组件化/README.md)、[规范化](./3%20规范化/README.md)、[自动化](./4%20自动化/README.md)这些角度出发，贯穿项目开发的整个过程。
