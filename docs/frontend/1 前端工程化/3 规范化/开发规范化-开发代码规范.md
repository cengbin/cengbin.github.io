...
### WebStrom 配置保存.css .less .scss 文件时候自动格式化代码

![](./assets/截图20260209094023.png)
...
首先，我们先安装eslint-plugin-prettier、eslint-config-prettier 插件，有了这两插件可以让你像运行 ESLint 规则一样运行
Prettier。
