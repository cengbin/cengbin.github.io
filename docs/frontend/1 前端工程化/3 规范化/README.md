...
1. [开发【流程】规范](./1%20开发流程规范.md)
2. [项目【目录】与【文件结构】规范](./2%20项目目录与文件结构规范.md)
3. [开发【代码】规范](./3%20开发代码规范.md)
4. [【git commit】规范](./4%20提交规范.md)
5. [【前后端接口分离】规范](./5%20前后端分离接口规范.md)
6. [Code Review 编码标准](./6%20Code%20Review%20编码标准.md)
